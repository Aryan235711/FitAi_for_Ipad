...
export function VitalityOrb() {
  // Simple morphing blob paths
    ...
    <div className="h-full w-full flex flex-col items-center justify-center relative overflow-hidden rounded-3xl">
      ...
      <div className="relative z-10 w-full h-[200px] flex items-center justify-center">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
            <span className="text-4xl font-display font-bold text-black mix-blend-overlay">98</span>
      ...
      <div className="mt-4 text-center z-10 px-4">
        <h3 className="text-lg font-medium text-white mb-1">Peak State</h3>
        <p className="text-xs text-white/50 leading-relaxed">
          Your biometrics suggest you are ready for a <span className="text-primary">HIIT session</span>.
        </p>
      </div>
    </div>
  );
